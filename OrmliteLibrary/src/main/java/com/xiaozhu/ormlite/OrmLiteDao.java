...
public class OrmLiteDao<T> {
    ...
    public boolean insert(T t) {
        int result = 0;
        try {
            T ts = ormLiteDao.createIfNotExists(t);
            if (ts != null) {
                result = 1;
            }
        } catch (SQLException e) {
     ...
     * @return 大于某个值的记录
     */
    public List<T> queryAllByLt(String orderColumn, Object value) {
        List<T> list = null;
        QueryBuilder queryBuilder = ormLiteDao.queryBuilder();
        Where where = queryBuilder.where();
        try {
            where.lt(orderColumn, value);
            list = queryBuilder.query();
        } catch (SQLException e) {
            e.printStackTrace();
        }
     ...
     * @return
     */
    public List<T> queryAllByOrder(Map<String, Object> map, String orderColumn, boolean ascending) {
        List<T> list = null;
        QueryBuilder queryBuilder = ormLiteDao.queryBuilder();
        Where where = queryBuilder.where();
        try {
     ...
     * @return
     */
    public List<T> queryForPagesLike(Map<String, Object> map, String columnName, String value, Long offset, Long count) {
        List<T> list = null;
        QueryBuilder queryBuilder = ormLiteDao.queryBuilder();
        Where where = queryBuilder.where();
        try {
     ...
     * @return
     */
    public T queryLikeForFirst(String columnName, Object value) {
        T t = null;
        QueryBuilder<T, Integer> queryBuilder = ormLiteDao.queryBuilder();
        try {
            queryBuilder.where().like(columnName, "%" + value + "%");
            t = queryBuilder.queryForFirst();
        } catch (SQLException e) {
            e.printStackTrace();
        }
     ...
     * @param value      指定值
     */
    public List<T> queryLikeList(String columnName, Object value) {
        List<T> list = null;
        QueryBuilder queryBuilder = ormLiteDao.queryBuilder();
        Where where = queryBuilder.where();
        try {
     ...
     * @param value      指定值
     */
    public List<T> queryLikeList(String columnName, Object value, Map<String, Object> map) {
        List<T> list = null;
        QueryBuilder queryBuilder = ormLiteDao.queryBuilder();
        Where where = queryBuilder.where();
        try {
